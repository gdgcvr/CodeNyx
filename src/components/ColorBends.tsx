...
export default function ColorBends({
    ...
    useEffect(() => {
        ...
        // Force clear any leftover canvases from React StrictMode / Fast Refresh
        ...
        try {
            ...
            // ... (rest of the logic will follow inside)
        } catch (e) {
            console.error("ThreeJS WebGL context creation failed", e);
            return;
        }
