...
const Highlights = () => {
    ...
    return (
        <section id="highlights" className="section-padding bg-bg-base relative">
            <div className="max-w-[1200px] mx-auto px-6">
                ...
                >
                    ...
                    <h2 className="font-display font-black text-[clamp(44px,7vw,80px)] text-accent-primary tracking-[-0.04em] leading-[1.05]">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="card-minimal md:col-span-2 md:row-span-2 min-h-[460px] flex flex-col justify-end">
                        ...
                        <div className="relative z-10 w-full md:w-[60%]">
                            ...
                            <p className="font-body text-[18px] text-accent-primary/50 leading-[1.6]">
                                A marathon of non-stop building. Deep focus, intense collaboration, and transformative breakthroughs.
                            </p>
                        </div>
                    </motion.div>

                    {/* Card 2: DSA Screening - Square */}
                    <motion.div variants={itemVariants} className="card-minimal min-h-[320px] bg-grid-pattern relative">
                        <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-tr from-[#0A0A0B] via-[#0A0A0B]/80 to-transparent" />
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            <div className="flex border-b border-accent-secondary/20 pb-4 mb-4 gap-2">
                            ...
                            <div>
                                ...
                                <p className="font-body text-[16px] text-accent-primary/50 leading-[1.6]">
                                    An algorithmic trial to shortlist the absolute sharpest technical minds.
                                </p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    <motion.div variants={itemVariants} className="card-minimal min-h-[320px] relative overflow-hidden">
                        {/* Visual: Glowing node map */}
                        <div className="absolute top-[10%] -right-[10%] w-[80%] h-[80%] opacity-30">
                            <svg viewBox="0 0 100 100" className="w-full h-full stroke-accent-primary/20" strokeWidth="0.5" fill="none">
                    ...
                    <motion.div variants={itemVariants} className="card-minimal md:col-span-2 relative bg-[#111111]">
                        <div className="absolute left-0 bottom-0 w-full h-[1px] bg-gradient-to-r from-transparent via-accent-secondary to-transparent opacity-30" />
                        <div className="flex flex-col md:flex-row gap-10 items-center justify-between z-10 relative">
                            <div className="flex-1">
                                ...
                                <p className="font-body text-[16px] text-accent-primary/50 leading-[1.6]">
                                    Meet builders, founders, and engineers who think like you. Forge connections that last long after the event ends.
                                </p>
                            </div>
                            <div className="w-[120px] h-[120px] shrink-0 border border-white/10 rounded-full flex items-center justify-center relative bg-black/40 shadow-[inset_0_0_20px_rgba(255,255,255,0.05)]">
