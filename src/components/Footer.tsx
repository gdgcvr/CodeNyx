...
const Footer = () => {
    ...
    return (
        <footer className="relative bg-bg-base overflow-hidden">
            ...
            <div className="absolute top-[50%] left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none select-none w-full overflow-hidden flex justify-center">
            ...
            <div className="absolute bottom-0 left-[15%] w-[300px] h-[300px] bg-accent-secondary/5 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute top-[20%] right-[10%] w-[200px] h-[200px] bg-accent-secondary/3 rounded-full blur-[100px] pointer-events-none" />
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-[16px]">
                                {navLinks.map((link, idx) => (
                                    ...
                                    >
                                        <span className="w-[16px] h-[1px] bg-white/10 group-hover:w-[28px] group-hover:bg-accent-secondary transition-all duration-300" />
                                        {link.label}
                                    </a>
                                ))}
                            </div>
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-[20px]">
                                ...
                                <div className="flex flex-col gap-[4px]">
                                    <span className="font-mono text-[10px] text-white/20 uppercase tracking-[2px]">Venue</span>
                                    <span className="font-body text-[15px] text-white/60">CVR College of Engineering</span>
                                </div>
                                <div className="flex flex-col gap-[4px]">
                                    <span className="font-mono text-[10px] text-white/20 uppercase tracking-[2px]">Date</span>
                                    <span className="font-body text-[15px] text-white/60">March 2026</span>
                                </div>
                                <div className="flex flex-col gap-[4px]">
                                    <span className="font-mono text-[10px] text-white/20 uppercase tracking-[2px]">Format</span>
                                    <span className="font-body text-[15px] text-white/60">36-Hour Offline Hackathon</span>
                                </div>
                            </div>
