    ...
    <section id="community" className="py-24 px-6 relative overflow-hidden">
      ...
      >
        <motion.div variants={itemVariants} className="mb-12">
          <h2 className="font-display font-black text-[clamp(40px,8vw,80px)] text-gradient-primary tracking-tight leading-[0.9] mb-6">
            Join the Community
          </h2>
        ...
        >
          ...
          >
            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-90 transition-opacity">
              <img src={waIcon} alt="" className="w-20 h-20" />
            </div>
            <div className="relative z-10 flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-[#25D366] flex items-center justify-center text-[#25D366] mb-6 group-hover:scale-110 transition-transform duration-500">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-[#5865F2] flex items-center justify-center text-[#5865F2] mb-6 group-hover:scale-110 transition-transform duration-500">
